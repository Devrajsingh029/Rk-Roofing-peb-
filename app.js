...
function renderFooter(){const isSub=location.pathname.includes('/projects/') || location.pathname.includes('/services/');const prefix=isSub?'../':'';return`<footer class="site-footer">
      ...
      <div class="container-x row">
        ...
        <div><h3>Services</h3><ul>
          <li><a href="${prefix}peb-construction.html">PEB Erection & Installation</a></li><li><a href="${prefix}industrial-roofing-services.html">Industrial Roofing</a></li><li><a href="${prefix}structural-steel-erection-services.html">Structural Steel Erection</a></li>
          <li><a href="${prefix}cladding-solutions-services.html">Wall Cladding Services</a></li><li><a href="${prefix}cladding-solutions-services.html">Insulated Panel Services</a></li><li><a href="${prefix}industrial-roofing-services.html">Standing Seam & Kalzip Roofing</a></li>
          <li><a href="${prefix}industrial-infrastructure-solutions.html">Airport Aircraft Hangars</a></li><li><a href="${prefix}warehouse-construction-services.html">Cold Storage Facilities</a></li>
        </ul></div>
