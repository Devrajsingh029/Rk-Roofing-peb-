...
function renderHeader(){const cur=currentPage();const isSub=location.pathname.includes('/projects/');const prefix=isSub?'../':'';const links=NAV.map(n=>`<a href="${prefix}${n.href}" class="${n.match.includes(cur)?'active':''}">${n.label}</a>`).join('');return`<header class="site-header" id="site-header">
      <div class="container-x row">
        <a href="${prefix}index.html" class="brand" aria-label="RK Roofing PEB Home">
          <img src="${prefix}assets/logo.png" alt="RK Roofing PEB - Official Company Logo" class="brand-logo-img" width="95" height="64" decoding="async"/>
        </a>
...
function renderFooter(){const isSub=location.pathname.includes('/projects/');const prefix=isSub?'../':'';return`<footer class="site-footer">
      <div class="grid-bg texture-grid"></div>
      <div class="container-x row">
        <div>
          <a href="${prefix}index.html" class="brand" style="margin-bottom:1.25rem;">
            <img src="${prefix}assets/logo.png" alt="RK Roofing PEB - Official Company Logo" class="brand-logo-img brand-logo-img--footer" width="106" height="72" loading="lazy" decoding="async"/>
          </a>
        ...
        <div><h3>Services</h3><ul>
          <li><a href="${prefix}peb-construction.html">PEB Construction</a></li><li><a href="${prefix}industrial-roofing-services.html">Industrial Roofing</a></li><li><a href="${prefix}structural-steel-erection-services.html">Structural Steel Erection</a></li>
          <li><a href="${prefix}warehouse-construction-services.html">Warehouse Construction</a></li><li><a href="${prefix}cladding-solutions-services.html">Cladding Solutions</a></li><li><a href="${prefix}industrial-infrastructure-solutions.html">Industrial Infrastructure</a></li>
        </ul></div>
