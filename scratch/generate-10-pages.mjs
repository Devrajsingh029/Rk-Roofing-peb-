...
const pagesData = {
  ...
  'industrial-roofing-services.html': {
    ...
    cards: [
      ...
      { icon: "settings", title: "Roofing Maintenance & Repair", desc: "Professional inspection, leak rectification, and preventive maintenance of existing metal roofs to extend their lifespan and ensure continuous protection." }
    ]
  },
  ...
  'insulated-panel-services.html': {
    ...
    cards: [
      { icon: "square", title: "PUF Insulated Panel Installation", desc: "Professional installation of Polyurethane Foam (PUF) panels for walls and roofs, ensuring precise joints, thermal efficiency, and structural stability." },
  ...
  'structural-steel-erection-services.html': {
    ...
    cards: [
      ...
      { icon: "construction", title: "Steel Mezzanine Platforms", desc: "Expert fabrication and field erection of elevated steel platforms, built to exact specifications for safe industrial access." }
    ]
  },
  'flashing-gutters.html': {
    ...
    cards: [
      ...
      { icon: "pipette", title: "Downpipe Installation", desc: "Secure attachment of uPVC or metal downpipes, correctly aligned to handle high-capacity water drainage from industrial roofs." },
  ...
  'maintenance-repair.html': {
    ...
    cards: [
      { icon: "settings", title: "PEB Maintenance", desc: "Systematic inspection and structural maintenance of pre-engineered buildings, ensuring bolt tightening, alignment checks, and long-term stability." },
      ...
      { icon: "droplet", title: "Leak Detection & Rectification", desc: "Thorough identification and repair of roof leaks, utilizing advanced sealing techniques, butyl tapes, and flashing replacements." },
      ...
      { icon: "settings", title: "Renovation & Retrofit Services", desc: "Expert upgrading of existing industrial facilities, including structural reinforcements, roof replacements, and cladding modernizations." }
    ]
  }
};

const mapIcon = (icon) => {
  // Safe mapping to Lucide icons
  const iconMap = {
    'factory': 'factory', 'layers': 'layers', 'building': 'building',
    'briefcase': 'briefcase', 'warehouse': 'warehouse', 'shield': 'shield',
    'wrench': 'wrench', 'settings': 'settings', 'home': 'home',
    'droplet': 'droplet', 'pipette': 'pipette', 'thermometer': 'thermometer',
    'sun': 'sun', 'square': 'square', 'snowflake': 'snowflake',
    'construction': 'construction'
  };
  return iconMap[icon] || 'check-circle';
};

// Extract standard <head> from index.html to preserve built Vite assets
  ...
  <body>
    ...
    <main id="main-content">
      ...
      <section class="section" style="background: #f9fafb; padding: 5rem 0;">
        <div class="container-x">
          <h2 class="h-section" style="margin-bottom: 3rem; font-size: 2rem; border-bottom: 2px solid var(--border); padding-bottom: 1rem;">Services Included</h2>
